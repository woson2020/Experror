...
f_re="(?e)(?P<p1>TCGCTCTTATTGACCACACC){e<=1}(?P<umi_f>[ATCG]{20})(?P<p2>GCTTCGGCAGCACATATACT){e<=1}"
r_re="(?e)(?P<p3>AGTATATGTGCTGCCGAAGC){e<=1}(?P<umi_r>[ATCG]{20})(?P<p4>GGTGTGGTCAATAAGAGCGA){e<=1}"
