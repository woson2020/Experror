...
umi_pattern=re.compile("TCGCTCTTATTGACCACACC\w{25}GCTTCGGCAGCACATATACT")# barcode(20bp)+index(5bp),actually,only the barcode(20bp) is useful in subsequent analysis
